"""model.py: CLI entry point for modeling tasks."""
import argparse
import logging
import os
import re
...
from ..insights.binary_clf_evaluation import BinaryModelInsights
...
logger = logging.getLogger('vmod.__main__(model)' if __name__ == '__main__' else __name__)
