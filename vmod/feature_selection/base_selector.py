"""base_selector.py: Defines the base class for feature selectors. Feature selector classes define methods for determining the data types
of features and selects which features to use for modeling
"""
import sys
